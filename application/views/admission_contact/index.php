      ...
      <div class="col-lg-7 mb-4 mb-lg-0">
        <form action="#">
          ...
          <select name="course" id="course" class="form-control mb-3" placeholder="Choose course">
            ...
            <option value="BMLT">B.Sc BMLT (Bachelor in Medical laboratory Technician)</option>
            <option value="OTT">B.Sc OTT ( B.Sc Operation Theatre Technology)</option>
            <option value="CCT">B.Sc CCT ( B.Sc Critical Care Technology)</option>
            <option value="PA">BSc PA(Bachelor in Physician Assistant)</option>
