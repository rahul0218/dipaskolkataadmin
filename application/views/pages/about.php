  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <ul>
          <li>BSc in Operation Theatre Technology (BSc OTT)</li>
          <li>BsC In Critical Care Technology (BSc CCT)</li>
          <li>Bachelor in Medical Lab Technology (BMLT)</li>
          <li>Bachelor in Physician Assistant (BSc PA)</li>
          <li>Bachelor In Physiotherapy (BPT)</li>
        </ul>
        <p>Our educational institute is a sister concern of Dishari Health Point Pvt Ltd a pioneer in health care delivery across the state of West Bengal. The training will help the students to get jobs in government and private hospitals, diagnostic centers and other corporates. </p>
        <p>To   promote quality education with morality all-round development of the student, leads to a contributing citizen & an effective “change agent” in an ever-changing society.</p>
...
<section class="section-sm bg-primary">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-4 mb-md-0">
        <div class="text-center">
          <h2 class="count text-white" data-count="300">0</h2>
